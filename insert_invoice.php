...
$select_query= mysqli_query($con,$select_sql);
	...
	$profit_amt = $profit*$qty;
            ...
            $insert_sql ="INSERT INTO on_hold (invoice_number, medicine_name, category, expire_date, qty, type, cost, amount, profit_amount, date)
			values('$invoice_number','$medicine_name','$category','$expire_date','$qty','$sell_type','$cost','$amount','$profit_amt','$date')";//*****INSERTING INTO on_HOLD TABLE*******
